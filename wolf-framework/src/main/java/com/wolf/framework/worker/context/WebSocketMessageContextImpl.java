...
public class WebSocketMessageContextImpl extends AbstractMessageContext implements FrameworkMessageContext {
    ...
    public WebSocketMessageContextImpl(GlobalApplication globalApplication, GlobalWebSocket globalWebSocket, String act, String message, CometContext cometContext) {
        super(act, message, cometContext);
    ...
    public void saveNewSession() {
        if (this.newSession != null) {
            ...
            if (session == null) {
                ...
                String newSid = this.newSession.getSid();
