 ...
 * @param <T>
 */
public class PushResponseImpl<T extends Entity> extends AbstractResponse implements PushResponse<T> {

    private Map<String, Object> dataMap = null;

    public PushResponseImpl(Response response, String[] returnParameter, Map<String, ResponseParameterHandler> responseHandlerMap) {
