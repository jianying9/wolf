...
public final class JsonUtils {
    ...
    public static String valuesToJSON(final String[] values, final ParameterHandler fieldHandler) {
    ...
    public static String mapToJSON(final Map<String, String> parameterMap, final String[] fieldNames, final Map<String, ParameterHandler> fieldMap) {
        String jsonStr = "{}";//return
    ...
    public static String mapListToJSON(List<Map<String, String>> parameterMapList, String[] fieldNames, Map<String, ParameterHandler> fieldMap) {
        String jsonStr = "";//return
    ...
    private static void mapToJSON(final Map<String, String> parameterMap, final String[] fieldNames, final Map<String, ParameterHandler> fieldMap, final StringBuilder jsonBuilder) {
        String value;
